...
async function BannerSectionContent({ fetcher }) {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 right-[12%] hidden md:flex bg-black">
        <CarouselPrevious className="w-[60px] h-[60px] bg-black"  />
        <CarouselNext className="w-[60px] h-[60px] ml-2 bg-black" />
      </div>
    </Carousel>
  )
}
